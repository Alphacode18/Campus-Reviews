		...
		<Layout style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
			...
			>
				...
				<Button
					...
					appearance="outline"
				>
					{loading === false ? <Text>Delete Account</Text> : <Spinner size="small" />}
				</Button>
				...
				<View style={styles.container}>
					...
					<Modal visible={visible} backdropStyle={styles.backdrop} onBackdropPress={() => setVisible(false)}>
						<Card disabled={true}>
							...
							<Text>
								Ans: Your credibility rating is a representation of how reliable other users found your
								answers and posts to be
							</Text>
							<Text>2. How can I improve my credibility rating?</Text>
							<Text>
								Ans: We recommend only answering about things you are sure about, ensuring that your
								answers are more likely to help people, rather than harm them.
							</Text>
							<Text>3. Can I change my usewname?</Text>
							<Text>Ans: Yes! You should be able to find the Edit Username screen at</Text>
							<Text>4. Can I change my account email ID?</Text>
							<Text>
								Ans: Yes, you can change your email using the _. You will have to verify once again that
								it is a Purdue email.
							</Text>
